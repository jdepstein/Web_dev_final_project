...
/** @typedef {import('../../types/config.d.ts').RawFile} RawFile */
/** @typedef {import('../../types/config.d.ts').FilePath} FilePath */
 ...
 *
 * @param {*} context
 * @param {import('vendors/tailwindcss/types').Config} tailwindConfig
 * @returns {ContentPath[]}
 */
